    ...
    agent: {
      ...
      instructions: [
        ...
        "A reference can override source-model joint values for instance-specific poses without modifying the source model.",
          ...
          "Reference interactions can expose proximity actions for power, seating, doors, and articulated joints; target feature ids and joint ids are relative to the referenced source model.",
