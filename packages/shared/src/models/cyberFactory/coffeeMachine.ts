...
export function createCoffeeMachine(
  ...
  return {
    ...
    featureGraph: {
      ...
      variables: [
        { id: "--coffee-machine-width", label: "宽度", type: "number", value: width, unit: "mm" },
        { id: "--coffee-machine-height", label: "高度", type: "number", value: height, unit: "mm" },
        { id: "--coffee-machine-depth", label: "深度", type: "number", value: depth, unit: "mm" },
      ],
    },
  };
}
