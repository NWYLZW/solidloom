...
export const copyByLocale = {
  "zh-CN": {
    ...
    interactionContainerConfigure: "配置",
    interactionContainerConfigureApply: "应用设置",
    interactionContainerConfigureGranted: "已获得管理权限",
    interactionContainerItemsView: "物品",
  ...
  en: {
    ...
    interactionContainerConfigure: "Settings",
    interactionContainerConfigureApply: "Apply",
    interactionContainerConfigureGranted: "Management access granted",
    interactionContainerItemsView: "Items",
